...
TOOL_DEFINITIONS: tuple[McpToolDefinition, ...] = (
    McpToolDefinition(
        ...
        required=("user_message", "agent_type"),
    ...
    McpToolDefinition(
        ...
        required=("session_id", "title", "summary", "content"),
    ...
    McpToolDefinition(
        ...
        required=("session_id", "step_key", "summary"),
    ...
    McpToolDefinition(
        ...
        required=("session_id", "slug", "name", "summary", "instructions"),
    ...
    McpToolDefinition(
        ...
        required=("session_id", "evidence_type", "source", "status", "conclusion"),
