...
> Historical pre-realignment plan. Its delivered work remains valid implementation evidence, but it does not define the current P4 phase. See `2026-08-13-agora-p1-p9-roadmap.md`.
