class AgoraMcpTools:
    ...
    def agora_submit_skill_candidate(
        self,
        *,
        session_id: str,
        slug: str,
        ...
        if not hasattr(self.harness, "submit_skill_candidate"):
            raise NotImplementedError("Harness does not implement submit_skill_candidate")
        payload = {
            "session_id": session_id,
            "slug": slug,
            "name": name,
